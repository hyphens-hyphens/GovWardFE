...
export function apiUsersGet$Json(http: HttpClient, rootUrl: string, params?: ApiUsersGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<UserAppListBaseResponse>> {
